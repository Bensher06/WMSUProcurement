  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.header}>
        <ThemedText type="title">Request history</ThemedText>
      ...
      {loading ? (
        ...
        <ThemedView style={styles.centerBox}>
          <ThemedText type="subtitle">No completed or rejected requests yet</ThemedText>
          <ThemedText style={styles.hint}>When requests are completed or rejected, they appear here.</ThemedText>
        </ThemedView>
      ) : (
