...
const Login = () => {
  ...
  useEffect(() => {
    ...
    const callbackErr = searchParams.get('auth_callback_error');
    if (confirmed === '1') {
      setSuccessBanner('Email confirmed. You can sign in with your password below.');
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <CenteredAlert
        ...
        success={successBanner || undefined}
        onClose={() => {
          setError('');
          setSuccessBanner('');
        }}
